...
namespace Projekat2Deo_Verzija1.Forme
{
    public partial class IgracForma : Form
    {
        ...
        {
            if(livTrenutniSegrti.SelectedItems.Count == 0)
            {
                MessageBox.Show($"Morate selektovati nekog šegrta!");
            }
            else
            {
        ...
        {
            (new SegrtForma(this, igrac.KontroliseLika.Id)).ShowDialog();
        }
        ...
        {
            if(livAlijanse.SelectedItems.Count == 0)
            {
                MessageBox.Show($"Morate prvo izabrati alijansu kojoj želite da se priključite");
            }
            else
            {
        ...
        {
            if (livIndividualniZadaci.SelectedItems.Count == 0)
            {
                MessageBox.Show($"Morate selektovati zadatak koji želite da rešite!");
            }
            else
            {
        ...
        {
            if(livBonusOprema.SelectedItems.Count == 0)
            {
                MessageBox.Show($"Morate selektovati opremu koju više ne želite da koristite!");
            }
            else
            {
        ...
        {
            if (livKljucnaOprema.SelectedItems.Count == 0)
            {
                MessageBox.Show($"Morate selektovati opremu koju više ne želite da koristite!");
            }
            else

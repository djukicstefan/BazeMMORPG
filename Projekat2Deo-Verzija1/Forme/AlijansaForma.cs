...
namespace Projekat2Deo_Verzija1.Forme
{
    public partial class AlijansaForma : Form
    {
        ...
        {
            if (listMoguciSavezi.SelectedIndex == -1)
            {
                MessageBox.Show("Izaberite alijansu sa kojom želite da sklopite savez!");
            }
            else
            {
        ...
        {
            if (listSavezi.SelectedIndex == -1)
            {
                MessageBox.Show("Izaberite alijansu sa kojom želite da prekinete savez!");
            }
            else
            {
        ...
        {
            if(livGrupniZadatak.SelectedItems.Count == 0)
            {
                MessageBox.Show($"Morate prvo izabrati zadatak koji želite da rešite");
            }
            else
            {
